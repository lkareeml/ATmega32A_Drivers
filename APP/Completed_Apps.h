...
/*          Date: 24-11-2023            */
/*          Version: 1.0                */
/*          Module: COMPLETED_APPS      */
/****************************************/
// App_001 to App_019


#ifndef COMPLETED_APPS_H_
#define COMPLETED_APPS_H_
/********************************************************************/
/***************     ADC -- Timer -- Interrupt *********************/
...
void App_014_ISR();
void App_013_LED_BUTTON_INTERRUPT();
void App_013_ISR();
void App_010_ADC_Manual_Interrupt();
void App_010_ISR_ADC();
void App_011_ADC_Timer_No_Interrupt();
...
/********************************************************************/
/*******   Seven_Segment -- Keypad -- LCD -- LED -- Button **********/
